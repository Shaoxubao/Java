...
public class SampleFlow {
	...
	public String toString() {
		return "SampleFlow [sampleId=" + sampleId + ", sampleNo=" + sampleNo
				+ ", sampleName=" + sampleName + ", mianRev=" + mianRev
				+ ", mianSend=" + mianSend + ", secondRev=" + secondRev
				+ ", secondSend=" + secondSend + ", zhurenRev=" + zhurenRev
				+ ", zhurenSend=" + zhurenSend + ", ywssqRev=" + ywssqRev
				+ ", ywssqSend=" + ywssqSend + ", headRev=" + headRev
				+ ", headSend=" + headSend + ", printRev=" + printRev
				+ ", printSend=" + printSend + ", jiaoduiRev=" + jiaoduiRev
				+ ", jiaoduiSend=" + jiaoduiSend + ", fachuRev=" + fachuRev
				+ ", fachuSend=" + fachuSend + "]";
	}
