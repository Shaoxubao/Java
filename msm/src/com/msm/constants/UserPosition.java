...
public enum UserPosition {
    ...
    PRODUCT_INSPECT(2, "检品检验"),      // 检验人员(主检科室)

    QUALITY_MANAGE(3, "质保科管理"),     // 质保科管理人员(会检科室)
    ...
    SIGNER_MANAGE(7, "审查签字人"),      // 受权签字人

    JIAODUI_MANAGE(8, "校对管理"),       // 校对

    FINAL_CHECK(9, "最终检验"),          // 最终检验

    REPORT_PRINT(10, "报告打印");        // 报告打印人员
